...
def getLoader(datasetName, dataroot, originalSize_h, originalSize_w, imageSize_h, imageSize_w, batchSize=64, workers=4,
  ...
  # TODO
  elif datasetName == 'my_loader_train':
    from datasets.my_loader import my_loader_train as commonDataset
    import transforms.pix2pix as transforms
  elif datasetName == "my_loader_LCDmoire":
    from datasets.my_loader import my_loader_LCDmoire as commonDataset
    import transforms.pix2pix as transforms
  elif datasetName == "my_loader_CFAmoire":
    from datasets.my_loader import my_loader_CFAmoire as commonDataset
    import transforms.pix2pix as transforms
  elif datasetName == "my_loader_mopnet":
    from datasets.my_loader import my_loader_mopnet as commonDataset
    import transforms.pix2pix as transforms
